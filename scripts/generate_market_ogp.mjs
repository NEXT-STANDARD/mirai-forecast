...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(80, 290)">
    ...
    <g transform="translate(0, 0)">
      <rect x="0" y="0" width="500" height="210" rx="14" fill="url(#cardBg)" stroke="rgba(56, 189, 248, 0.35)" stroke-width="1.5"/>
      ...
      <text x="180" y="37" fill="#94a3b8" font-family="'Noto Sans JP', sans-serif" font-size="13">世界のリアルマネー (Polymarket)</text>
    ...
    <g transform="translate(540, 0)">
      <rect x="0" y="0" width="500" height="210" rx="14" fill="url(#cardBg)" stroke="${hasConsensus ? 'rgba(52, 211, 153, 0.4)' : 'rgba(251, 191, 36, 0.35)'}" stroke-width="1.5"/>
    ...
    <g transform="translate(425, 85)">
      <rect x="0" y="0" width="190" height="36" rx="18" fill="#0f172a" stroke="rgba(244, 63, 94, 0.6)" stroke-width="1.5"/>
      <text x="95" y="23" fill="#fb7185" font-family="monospace, sans-serif" font-size="12" font-weight="bold" text-anchor="middle">${gapText}</text>
    </g>
  </g>
