  ...
  return (
    <div className="w-full animate-fade-in text-slate-200 py-2">
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        {/* §1 ミッション */}
        <section className="bg-[#0b1320] border border-cyan-900/60 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-4">
          <div className="flex items-center gap-3 text-cyan-400">
            <Eye size={22} />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">1. 私たちのミッション（なぜ未来予測なのか？）</h2>
          </div>
        ...
        {/* §2 気象台モデル */}
        <section className="bg-[#0b1320] border border-cyan-900/60 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-6">
          <div className="flex items-center gap-3 text-amber-400">
            <Scale size={22} />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">2. 「気象台モデル」— 胴元（House）を持たない公共インフラ</h2>
          </div>
          <div className="bg-amber-950/30 border border-amber-500/40 rounded-xl p-5 text-amber-200 text-sm leading-relaxed">
            <span className="font-bold block mb-1 text-amber-300">⚠️ 賭博性ゼロの公共情報ポータル</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            <div className="p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <span className="text-cyan-400 text-xs font-mono font-bold block mb-1.5">01. 参加費 0円</span>
              <p className="text-xs text-slate-400 leading-relaxed">登録不要・課金なし・1クリックで日本の世論を形成。</p>
            </div>
            <div className="p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <span className="text-cyan-400 text-xs font-mono font-bold block mb-1.5">02. 胴元なし</span>
              <p className="text-xs text-slate-400 leading-relaxed">運営者に利害関係がなく、オッズや世論を歪めない構造。</p>
            </div>
            <div className="p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <span className="text-cyan-400 text-xs font-mono font-bold block mb-1.5">03. 公開オラクル</span>
              <p className="text-xs text-slate-400 leading-relaxed">決着は公的発表・公式記録に基づいて自動アーカイブ。</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#0b1320] border border-cyan-900/60 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-6">
          <div className="flex items-center gap-3 text-emerald-400">
            <ShieldCheck size={22} />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">3. 銘柄の「3大上場基準（Listing Triple Standard）」</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
            無責任なデマ、誹謗中傷、主観的な陰謀論を100%排除するため、当サイトに掲載される全ての銘柄は以下の3基準を厳格にクリアしています。
          </p>
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <CheckCircle2 size={22} className="text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h3 className="font-bold text-white text-base mb-1.5">① 確定的検証性（Verifiable Truth）</h3>
            ...
            <div className="flex items-start gap-4 p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <CheckCircle2 size={22} className="text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h3 className="font-bold text-white text-base mb-1.5">② 公共性・倫理（Public Interest & Ethics）</h3>
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
            ...
            <div className="flex items-start gap-4 p-5 rounded-xl bg-slate-950/70 border border-cyan-900/40">
              <CheckCircle2 size={22} className="text-emerald-400 shrink-0 mt-0.5" />
              <div>
                <h3 className="font-bold text-white text-base mb-1.5">③ 問いの中立性（Neutral Framing）</h3>
                <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
        ...
        <section className="bg-[#0b1320] border border-cyan-900/60 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-4">
          <div className="flex items-center gap-3 text-purple-400">
            <Bot size={22} />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">4. WebMCP ＆ オープンデータ宣言（生成AIとの共生）</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
          ...
          <div className="flex flex-wrap gap-2 text-xs font-mono pt-2">
            <span className="px-3 py-1.5 rounded-lg bg-purple-950/60 border border-purple-800/50 text-purple-300">WebMCP Ready</span>
            <span className="px-3 py-1.5 rounded-lg bg-purple-950/60 border border-purple-800/50 text-purple-300">Schema.org / JSON-LD</span>
            <span className="px-3 py-1.5 rounded-lg bg-purple-950/60 border border-purple-800/50 text-purple-300">Open Data Export</span>
          </div>
        </section>
        ...
        <section className="bg-[#0b1320] border border-cyan-900/60 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-6">
          <div className="flex items-center gap-3 text-blue-400">
            <Building2 size={22} />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">5. 運営体制 ＆ ガバナンス情報</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              <tbody>
                <tr className="border-b border-cyan-900/40">
                  <th className="py-3.5 px-4 text-slate-400 font-medium w-40 bg-slate-950/60">サービス名称</th>
                ...
                <tr className="border-b border-cyan-900/40">
                  ...
                  <td className="py-3.5 px-4 text-slate-300">Web3×集合知 非胴元型インテリジェンス・メディア（パブリック・グッズ構想）</td>
                </tr>
                <tr>
          ...
          {onOpenProposeModal && (
            <div className="pt-6 border-t border-cyan-900/40 text-center">
