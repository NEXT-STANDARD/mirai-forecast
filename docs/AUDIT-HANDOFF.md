...
1. **C の残り: 告知の実行** — 素材は [embed-promo-2026-08-25.md](embed-promo-2026-08-25.md) に完成
   （X告知ロング＋短縮＋リプライ／メディア向け案内1ページ／当て先メモ／禁止表現リスト）。
   トーン3原則: 数字は母集団と一緒・外れを先に言う・賭けに誘導しない。
   **投稿はユーザーが実行**（投稿前に track_record 再生成と乖離実例の当日値差し替えが必須。
   ホルムズの例は 8/31 決着後に差し替え）
